...
class AlbumView: UIView {
    ...
    private func setMainStack() {
        ...
        mainStack.addArrangedSubview(createIamgeWithButton(nameImage: "NadaPersonal", nameButton: "Soda Stereo: Album Nada Personal", tag: 0))
        mainStack.addArrangedSubview(createIamgeWithButton(nameImage: "signos", nameButton: "Soda Stereo: Album Signos", tag: 1))
        mainStack.addArrangedSubview(createIamgeWithButton(nameImage: "SodaStereo", nameButton: "Soda Stereo: Album Soda Stereo", tag: 2))
    }
